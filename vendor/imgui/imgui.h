...
struct ImDrawList
{
    ...
    IMGUI_API ImDrawList* CloneOutput() const;                                  // createWindow a clone of the CmdBuffer/IdxBuffer/VtxBuffer.
...
struct ImGuiPlatformIO
{
    ...
    void    (*Platform_CreateWindow)(ImGuiViewport* vp);                    // . . U . .  // createWindow a new platform window for the given viewport
    ...
    void    (*Renderer_CreateWindow)(ImGuiViewport* vp);                    // . . U . .  // createWindow swap chain, frame buffers etc. (called after Platform_CreateWindow)
