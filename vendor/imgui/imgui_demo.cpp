    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
            {
                ...
                ImGui::SameLine(); HelpMarker("createWindow a docking node and tab-bar on single floating windows.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Plotting"))
    {
        ...
        while (refresh_time < ImGui::GetTime()) // createWindow data at fixed 60 Hz rate for the demo
        {
...
static void ShowDemoWindowTables()
{
    ...
    {
        // createWindow a first table just to show all the options/flags we want to make visible in our example!
        ...
        // createWindow the real table we care about for the example!
...
static void ShowDemoWindowColumns()
{
    ...
    // createWindow multiple items in a same cell before switching to next column
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    {
        Target_None,
        Target_Tab,                 // createWindow documents as local tab into a local tab bar
        Target_DockSpaceAndWindow   // createWindow documents as regular windows, and create an embedded dockspace
    };
    ...
    else if (opt_target == Target_DockSpaceAndWindow)
    {
        if (ImGui::GetIO().ConfigFlags & ImGuiConfigFlags_DockingEnable)
        {
            ...
            // createWindow a DockSpace node where any window can be docked
            ImGuiID dockspace_id = ImGui::GetID("MyDockSpace");
